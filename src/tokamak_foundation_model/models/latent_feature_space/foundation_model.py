...
class PerceiverFoundationModel(nn.Module):
    ...
    def __init__(
        ...
        # --- Actuator tokenizer (for encoder context + cross-attn dynamics) ---
        if actuator_configs is not None and dynamics_type == "cross_attention":
    ...
    def forward(
        ...
        if self.dynamics_type == "cross_attention":
